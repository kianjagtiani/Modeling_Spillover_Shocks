...
Sharpe gap of 0.71 — flagged in our own summary as overfitting. The permutation test says
...
- Options. `src/options_strategy.py` sketches the Deribit volatility-risk-premium trade
  (IV typically 10–20% over realized) — that's where a good RV forecast earns, and it
